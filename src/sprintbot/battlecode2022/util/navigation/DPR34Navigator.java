...
public class DPR34Navigator extends Navigator
{
	...
	public DPR34Navigator(RobotController controller)
	{
		super(controller);
		rc = controller;
	...
	public MoveResult move(MapLocation target_loc) throws GameActionException
	{
		...
		//System.out.printf("Check Complete, left = 34\n", Clock.getBytecodesLeft());
		...
		int d_n3_5 = Math.min(Math.min(d_n2_4,d_n3_4),d_n4_4)+r_n3_5;
		...
		int d_5_3 = Math.min(Math.min(d_4_4,d_4_3),d_4_2)+r_5_3;
		...
		int d_3_n5 = Math.min(Math.min(d_4_n4,d_3_n4),d_2_n4)+r_3_n5;
		tmp_loc = current_loc.translate(2,-5);
		...
		int d_n5_n3 = Math.min(Math.min(d_n4_n2,d_n4_n3),d_n4_n4)+r_n5_n3;
		tmp_loc = current_loc.translate(-5,-2);
		...
		d_n4_3 = Math.min(Math.min(Math.min(Math.min(Math.min(Math.min(Math.min(d_n3_4,d_n3_3),d_n3_2),d_n4_4),d_n4_2),d_n5_3),d_n5_2)+r_n4_3,d_n4_3);
		...
		d_n4_n3 = Math.min(Math.min(Math.min(Math.min(Math.min(Math.min(Math.min(d_n3_n2,d_n3_n3),d_n3_n4),d_n4_n2),d_n4_n4),d_n5_n2),d_n5_n3)+r_n4_n3,d_n4_n3);
		d_n4_n4 = Math.min(Math.min(Math.min(Math.min(Math.min(d_n3_n3,d_n3_n4),d_n3_n5),d_n4_n3),d_n5_n3)+r_n4_n4,d_n4_n4);
		d_n3_n4 = Math.min(Math.min(Math.min(Math.min(Math.min(Math.min(Math.min(d_n2_n3,d_n2_n4),d_n2_n5),d_n3_n3),d_n3_n5),d_n4_n3),d_n4_n4)+r_n3_n4,d_n3_n4);
		...
		d_3_n4 = Math.min(Math.min(Math.min(Math.min(Math.min(Math.min(Math.min(d_4_n3,d_4_n4),d_3_n3),d_3_n5),d_2_n3),d_2_n4),d_2_n5)+r_3_n4,d_3_n4);
		d_4_n4 = Math.min(Math.min(Math.min(Math.min(Math.min(d_5_n3,d_4_n3),d_3_n3),d_3_n4),d_3_n5)+r_4_n4,d_4_n4);
		d_4_n3 = Math.min(Math.min(Math.min(Math.min(Math.min(Math.min(Math.min(d_5_n2,d_5_n3),d_4_n2),d_4_n4),d_3_n2),d_3_n3),d_3_n4)+r_4_n3,d_4_n3);
		...
		d_4_3 = Math.min(Math.min(Math.min(Math.min(Math.min(Math.min(Math.min(d_5_3,d_5_2),d_4_4),d_4_2),d_3_4),d_3_3),d_3_2)+r_4_3,d_4_3);
		d_4_4 = Math.min(Math.min(Math.min(Math.min(Math.min(d_5_3,d_4_3),d_3_5),d_3_4),d_3_3)+r_4_4,d_4_4);
		d_3_4 = Math.min(Math.min(Math.min(Math.min(Math.min(Math.min(Math.min(d_4_4,d_4_3),d_3_5),d_3_3),d_2_5),d_2_4),d_2_3)+r_3_4,d_3_4);
		...
		d_n3_4 = Math.min(Math.min(Math.min(Math.min(Math.min(Math.min(Math.min(d_n2_5,d_n2_4),d_n2_3),d_n3_5),d_n3_3),d_n4_4),d_n4_3)+r_n3_4,d_n3_4);
		d_n4_4 = Math.min(Math.min(Math.min(Math.min(Math.min(d_n3_5,d_n3_4),d_n3_3),d_n4_3),d_n5_3)+r_n4_4,d_n4_4);
		d_n5_3 = Math.min(Math.min(Math.min(Math.min(d_n4_4,d_n4_3),d_n4_2),d_n5_2)+r_n5_3,d_n5_3);
		d_n5_2 = Math.min(Math.min(Math.min(Math.min(Math.min(d_n4_3,d_n4_2),d_n4_1),d_n5_3),d_n5_1)+r_n5_2,d_n5_2);
		d_n5_1 = Math.min(Math.min(Math.min(Math.min(Math.min(d_n4_2,d_n4_1),d_n4_0),d_n5_2),d_n5_0)+r_n5_1,d_n5_1);
		d_n5_0 = Math.min(Math.min(Math.min(Math.min(Math.min(d_n4_1,d_n4_0),d_n4_n1),d_n5_1),d_n5_n1)+r_n5_0,d_n5_0);
		d_n5_n1 = Math.min(Math.min(Math.min(Math.min(Math.min(d_n4_0,d_n4_n1),d_n4_n2),d_n5_0),d_n5_n2)+r_n5_n1,d_n5_n1);
		d_n5_n2 = Math.min(Math.min(Math.min(Math.min(Math.min(d_n4_n1,d_n4_n2),d_n4_n3),d_n5_n1),d_n5_n3)+r_n5_n2,d_n5_n2);
		d_n5_n3 = Math.min(Math.min(Math.min(Math.min(d_n4_n2,d_n4_n3),d_n4_n4),d_n5_n2)+r_n5_n3,d_n5_n3);
		d_n3_n5 = Math.min(Math.min(Math.min(Math.min(d_n2_n4,d_n2_n5),d_n3_n4),d_n4_n4)+r_n3_n5,d_n3_n5);
		d_n2_n5 = Math.min(Math.min(Math.min(Math.min(Math.min(d_n1_n4,d_n1_n5),d_n2_n4),d_n3_n4),d_n3_n5)+r_n2_n5,d_n2_n5);
		d_n1_n5 = Math.min(Math.min(Math.min(Math.min(Math.min(d_0_n4,d_0_n5),d_n1_n4),d_n2_n4),d_n2_n5)+r_n1_n5,d_n1_n5);
		d_0_n5 = Math.min(Math.min(Math.min(Math.min(Math.min(d_1_n4,d_1_n5),d_0_n4),d_n1_n4),d_n1_n5)+r_0_n5,d_0_n5);
		d_1_n5 = Math.min(Math.min(Math.min(Math.min(Math.min(d_2_n4,d_2_n5),d_1_n4),d_0_n4),d_0_n5)+r_1_n5,d_1_n5);
		d_2_n5 = Math.min(Math.min(Math.min(Math.min(Math.min(d_3_n4,d_3_n5),d_2_n4),d_1_n4),d_1_n5)+r_2_n5,d_2_n5);
		d_3_n5 = Math.min(Math.min(Math.min(Math.min(d_4_n4,d_3_n4),d_2_n4),d_2_n5)+r_3_n5,d_3_n5);
		d_5_n3 = Math.min(Math.min(Math.min(Math.min(d_5_n2,d_4_n2),d_4_n3),d_4_n4)+r_5_n3,d_5_n3);
		d_5_n2 = Math.min(Math.min(Math.min(Math.min(Math.min(d_5_n1,d_5_n3),d_4_n1),d_4_n2),d_4_n3)+r_5_n2,d_5_n2);
		d_5_n1 = Math.min(Math.min(Math.min(Math.min(Math.min(d_5_0,d_5_n2),d_4_0),d_4_n1),d_4_n2)+r_5_n1,d_5_n1);
		d_5_0 = Math.min(Math.min(Math.min(Math.min(Math.min(d_5_1,d_5_n1),d_4_1),d_4_0),d_4_n1)+r_5_0,d_5_0);
		d_5_1 = Math.min(Math.min(Math.min(Math.min(Math.min(d_5_2,d_5_0),d_4_2),d_4_1),d_4_0)+r_5_1,d_5_1);
		d_5_2 = Math.min(Math.min(Math.min(Math.min(Math.min(d_5_3,d_5_1),d_4_3),d_4_2),d_4_1)+r_5_2,d_5_2);
		d_5_3 = Math.min(Math.min(Math.min(Math.min(d_5_2,d_4_4),d_4_3),d_4_2)+r_5_3,d_5_3);
		d_3_5 = Math.min(Math.min(Math.min(Math.min(d_4_4,d_3_4),d_2_5),d_2_4)+r_3_5,d_3_5);
		d_2_5 = Math.min(Math.min(Math.min(Math.min(Math.min(d_3_5,d_3_4),d_2_4),d_1_5),d_1_4)+r_2_5,d_2_5);
		d_1_5 = Math.min(Math.min(Math.min(Math.min(Math.min(d_2_5,d_2_4),d_1_4),d_0_5),d_0_4)+r_1_5,d_1_5);
		d_0_5 = Math.min(Math.min(Math.min(Math.min(Math.min(d_1_5,d_1_4),d_0_4),d_n1_5),d_n1_4)+r_0_5,d_0_5);
		d_n1_5 = Math.min(Math.min(Math.min(Math.min(Math.min(d_0_5,d_0_4),d_n1_4),d_n2_5),d_n2_4)+r_n1_5,d_n1_5);
		d_n2_5 = Math.min(Math.min(Math.min(Math.min(Math.min(d_n1_5,d_n1_4),d_n2_4),d_n3_5),d_n3_4)+r_n2_5,d_n2_5);
		d_n3_5 = Math.min(Math.min(Math.min(Math.min(d_n2_5,d_n2_4),d_n3_4),d_n4_4)+r_n3_5,d_n3_5);
		...
		if (dctd <= 34)
		{
			switch ((7-dctx)*15+7-dcty)
			{
				...
				default:System.out.printf("Error in DPNavigator: unexpected encoded value 190",(7-dctx)*15+7-dcty);break;
			}
		}
		else
		{
			minDistance = Math.min(minDistance, d_n5_n3 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(-5 + dctx), Math.abs(-3 + dcty)));
			minDistance = Math.min(minDistance, d_n5_n2 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(-5 + dctx), Math.abs(-2 + dcty)));
			minDistance = Math.min(minDistance, d_n5_n1 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(-5 + dctx), Math.abs(-1 + dcty)));
			minDistance = Math.min(minDistance, d_n5_0 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(-5 + dctx), Math.abs(0 + dcty)));
			minDistance = Math.min(minDistance, d_n5_1 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(-5 + dctx), Math.abs(1 + dcty)));
			minDistance = Math.min(minDistance, d_n5_2 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(-5 + dctx), Math.abs(2 + dcty)));
			minDistance = Math.min(minDistance, d_n5_3 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(-5 + dctx), Math.abs(3 + dcty)));
			minDistance = Math.min(minDistance, d_n4_n4 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(-4 + dctx), Math.abs(-4 + dcty)));
			minDistance = Math.min(minDistance, d_n4_n3 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(-4 + dctx), Math.abs(-3 + dcty)));
			minDistance = Math.min(minDistance, d_n4_3 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(-4 + dctx), Math.abs(3 + dcty)));
			minDistance = Math.min(minDistance, d_n4_4 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(-4 + dctx), Math.abs(4 + dcty)));
			minDistance = Math.min(minDistance, d_n3_n5 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(-3 + dctx), Math.abs(-5 + dcty)));
			minDistance = Math.min(minDistance, d_n3_n4 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(-3 + dctx), Math.abs(-4 + dcty)));
			minDistance = Math.min(minDistance, d_n3_4 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(-3 + dctx), Math.abs(4 + dcty)));
			minDistance = Math.min(minDistance, d_n3_5 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(-3 + dctx), Math.abs(5 + dcty)));
			minDistance = Math.min(minDistance, d_n2_n5 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(-2 + dctx), Math.abs(-5 + dcty)));
			minDistance = Math.min(minDistance, d_n2_5 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(-2 + dctx), Math.abs(5 + dcty)));
			minDistance = Math.min(minDistance, d_n1_n5 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(-1 + dctx), Math.abs(-5 + dcty)));
			minDistance = Math.min(minDistance, d_n1_5 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(-1 + dctx), Math.abs(5 + dcty)));
			minDistance = Math.min(minDistance, d_0_n5 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(0 + dctx), Math.abs(-5 + dcty)));
			minDistance = Math.min(minDistance, d_0_5 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(0 + dctx), Math.abs(5 + dcty)));
			minDistance = Math.min(minDistance, d_1_n5 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(1 + dctx), Math.abs(-5 + dcty)));
			minDistance = Math.min(minDistance, d_1_5 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(1 + dctx), Math.abs(5 + dcty)));
			minDistance = Math.min(minDistance, d_2_n5 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(2 + dctx), Math.abs(-5 + dcty)));
			minDistance = Math.min(minDistance, d_2_5 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(2 + dctx), Math.abs(5 + dcty)));
			minDistance = Math.min(minDistance, d_3_n5 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(3 + dctx), Math.abs(-5 + dcty)));
			minDistance = Math.min(minDistance, d_3_n4 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(3 + dctx), Math.abs(-4 + dcty)));
			minDistance = Math.min(minDistance, d_3_4 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(3 + dctx), Math.abs(4 + dcty)));
			minDistance = Math.min(minDistance, d_3_5 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(3 + dctx), Math.abs(5 + dcty)));
			minDistance = Math.min(minDistance, d_4_n4 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(4 + dctx), Math.abs(-4 + dcty)));
			minDistance = Math.min(minDistance, d_4_n3 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(4 + dctx), Math.abs(-3 + dcty)));
			minDistance = Math.min(minDistance, d_4_3 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(4 + dctx), Math.abs(3 + dcty)));
			minDistance = Math.min(minDistance, d_4_4 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(4 + dctx), Math.abs(4 + dcty)));
			minDistance = Math.min(minDistance, d_5_n3 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(5 + dctx), Math.abs(-3 + dcty)));
			minDistance = Math.min(minDistance, d_5_n2 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(5 + dctx), Math.abs(-2 + dcty)));
			minDistance = Math.min(minDistance, d_5_n1 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(5 + dctx), Math.abs(-1 + dcty)));
			minDistance = Math.min(minDistance, d_5_0 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(5 + dctx), Math.abs(0 + dcty)));
			minDistance = Math.min(minDistance, d_5_1 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(5 + dctx), Math.abs(1 + dcty)));
			minDistance = Math.min(minDistance, d_5_2 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(5 + dctx), Math.abs(2 + dcty)));
			minDistance = Math.min(minDistance, d_5_3 + UPPER_BOUND_TURN_PER_GRID * Math.max(Math.abs(5 + dctx), Math.abs(3 + dcty)));
		}
